...
<head>
    ...
    <title>Saradha Lanka Agro Company</title>
    <meta name="keywords" content="HTML5 Template">
    <meta name="description" content="Molla - Bootstrap eCommerce Template">
    <meta name="author" content="p-themes">
    <!-- Favicon -->
    <link rel="apple-touch-icon" sizes="180x180"
        href="<?= base_url('/public/client/assets/images/icons/apple-touch-icon.png') ?>">
    <link rel="icon" type="image/png" sizes="32x32"
        href="<?= base_url('/public/client/assets/images/icons/favicon-32x32.png') ?>">
    <link rel="icon" type="image/png" sizes="16x16"
        href="<?= base_url('/public/client/assets/images/icons/favicon-16x16.png') ?>">
    <link rel="manifest" href="<?= base_url('/public/client/assets/images/icons/site.html') ?>">
    <link rel="mask-icon" href="<?= base_url('/public/client/assets/images/icons/safari-pinned-tab.svg') ?>"
        color="#666666">
    <link rel="shortcut icon" href="<?= base_url('/public/client/assets/images/icons/favicon.ico') ?>">
    <meta name="apple-mobile-web-app-title" content="Molla">
    <meta name="application-name" content="Molla">
    <meta name="msapplication-TileColor" content="#66CC91">
    <meta name="msapplication-config" content="<?= base_url('/public/client/assets/images/icons/browserconfig.xml') ?>">
    <meta name="theme-color" content="#ffffff">
    <!-- Plugins CSS File -->
    <link rel="stylesheet" href="<?= base_url('/public/client/assets/css/bootstrap.min.css') ?>">
    <link rel="stylesheet" href="<?= base_url('/public/client/assets/css/plugins/owl-carousel/owl.carousel.css') ?>">
    <link rel="stylesheet"
        href="<?= base_url('/public/client/assets/css/plugins/magnific-popup/magnific-popup.css') ?>">
    <!-- Main CSS File -->
...
<body>
                                        ...
                                        <div class="menu-col">
                                            ...
                                            <div class="demo-list">
                                                <div class="demo-item">
                                                    <a href="index-1.html">
                                                        <span class="demo-bg"
                                                            style="background-image: url(assets/images/menu/de</a>mos/1.jpg);"></span>
                                                ...
                                                <div class="demo-item">
                                                    ...
                                                    </a> <span class="demo-title">02 - furniture store</span>
                                                    </a>
                                                </div><!-- End .demo-item -->
                                                ...
                                                <div class="demo-item hidden">
                                                    <a href="index-11.html">
                                                        <span class</a>="demo-bg"
                                                            style="background-image:
                                                            url(assets/images/menu/demos/11.jpg);"></span>
                                                ...
                                                <div class="demo-item hidden">
                                                    <a href="index-12.html">
                                                        <span class="demo-bg" </a> style="background-image:
                                                            url(assets/images/menu/demos/12.jpg);"></span>
                                                ...
                                                <div class="demo-item hidden">
                                                    <a href="index-13.html">
                                                        <span class="demo-bg"
                                                            style="background-image: url</a>(assets/images/menu/demos/13.jpg);"></span>
                                                ...
                                                <div class="demo-item hidden">
                                                    ...
                                                    </a> <span class="demo-title">14 - market fullwidth</span>
                                                    </a>
                                                </div><!-- End .demo-item -->
                                                ...
                                                <div class="demo-item hidden">
                                                    <a href="index-15.html">
                                                        ...
                                                        <span class=</a>"demo-title">15 - lookbook 1</span>
                                                    </a>
                                                </div><!-- End .demo-item -->
                                            ...
                                            <div class="megamenu-action text-center">
                                                <a href="#"
                                                    class="btn </a>btn-outline-primary-2 view-all-demos"><span>View
                                    ...
                                    <div class="col-md-6 col-lg-12">
                                        <div class="banner banner-display">
                                            ...
                                            <div class="banner-content">
                                                ...
                                                <h3 class="banner-title text-white"><a href="#">Chairs & Chaises <br>Up
                                                        to 40% off</a></h3><!-- End .banner-title -->
    ...
    <!-- Plugins JS File -->
    <script src="<?= base_url('/public/client/assets/js/jquery.min.js') ?>"></script>
    <script src="<?= base_url('/public/client/assets/js/bootstrap.bundle.min.js') ?>"></script>
    <script src="<?= base_url('/public/client/assets/js/jquery.hoverIntent.min.js') ?>"></script>
    <script src="<?= base_url('/public/client/assets/js/jquery.waypoints.min.js') ?>"></script>
    <script src="<?= base_url('/public/client/assets/js/superfish.min.js') ?>"></script>
    <script src="<?= base_url('/public/client/assets/js/owl.carousel.min.js') ?>"></script>
    <script src="<?= base_url('/public/client/assets/js/jquery.magnific-popup.min.js') ?>"></script>
    <!-- Main JS File -->
    <script src="<?= base_url('/public/client/assets/js/main.js') ?>"></script>
